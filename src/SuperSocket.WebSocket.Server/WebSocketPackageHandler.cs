...
namespace SuperSocket.WebSocket.Server
{
    public class WebSocketPackageHandler : IPackageHandler<WebSocketPackage>
    {
        ...
        /// 选择子协议
        /// </summary>
        /// <param name="requestedProtocols">请求协议</param>
        /// <param name="selectedProtocol">选择的协议</param>
        /// <param name="selectedProtocolHandler">选择的协议处理</param>
        /// <returns></returns>
        ...
        /// 选择扩展 
        /// </summary>
        /// <param name="requestedExtensions">请求的扩展</param>
        /// <param name="extensions">扩展列表</param>
        /// <returns></returns>
        ...
        /// <param name="selectedExtensionHeadItems">选择扩展头</param>
